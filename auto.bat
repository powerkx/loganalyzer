...
set start_time=2016-11-25 00:00
set end_time=2016-11-26 00:00
set log_folder=2016-11-25
...
set time_c=%date:~0,4%-%date:~5,2%-%date:~8,2%-%time:~0,2%00
mkdir "result_csv\%time_c%"
